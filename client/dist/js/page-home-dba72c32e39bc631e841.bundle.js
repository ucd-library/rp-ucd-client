(window.webpackJsonp=window.webpackJsonp||[]).push([[4],{108:function(e,t,i){"use strict";i.r(t),i.d(t,"default",(function(){return h}));var r=i(2),s=i(37),o=i(10),n=i(11);
/**
 * @license
 ...
 */
const a=new WeakMap;Object(n.d)((...e)=>t=>{let i=a.get(t);void 0===i&&(i={lastRenderedIndex:2147483647,values:[]},a.set(t,i));const r=i.values;let s=r.length;i.values=e;for(let n=0;n<e.length&&!(n>i.lastRenderedIndex);n++){const a=e[n];if(Object(o.h)(a)||"function"!=typeof a.then){t.setValue(a),i.lastRenderedIndex=n;break}n<s&&a===r[n]||(i.lastRenderedIndex=2147483647,s=0,Promise.resolve(a).then(e=>{const r=i.values.indexOf(a);r>-1&&r<i.lastRenderedIndex&&(i.lastRenderedIndex=r,t.setValue(e),t.commit())}))}});var l=i(34),c=i.n(l);function d(){return r.b`
...
`}i(15),i(89),i(98),i(90),i(99),i(93);class h extends(Mixin(r.a).with(LitCorkUtils)){static get properties(){return{theme:{type:Object},facetsStatus:{type:String},facets:{type:Object},academicWorks:{type:Array},academicWorksTotal:{type:parseInt},peopleStatus:{type:String},people:{type:Array},peopleTotal:{type:parseInt},peopleWidth:{type:parseInt},subjectsTotal:{type:parseInt},context:{type:String},visible:{type:Boolean}}}constructor(){super(),this.render=d.bind(this),this._injectModel("CollectionModel","AppStateModel"),this.reset_properties(),this.facets={},this.academicWorksTotal=0,this.peopleTotal=0,this.subjectsTotal=0,this.setPeopleWidth(window.innerWidth),this.context=APP_CONFIG.data.jsonldContext,this.theme=APP_CONFIG.theme,this.AppStateModel.get().then(e=>this._onAppStateUpdate(e)),this._handleResize=this._handleResize.bind(this)}reset_properties(){this.people=[],this.academicWorks=[],this.visible=!1,this.facetsStatus="loading",this.peopleStatus="loading"}updated(e){e.has("facetsStatus")&&"loaded"==this.facetsStatus&&this._getPeople(),e.has("visible")&&this.visible&&requestAnimationFrame(()=>this._handleResize())}connectedCallback(){super.connectedCallback(),window.addEventListener("resize",this._handleResize)}disconnectedCallback(){window.removeEventListener("resize",this._handleResize),super.disconnectedCallback()}async doUpdate(e){await this.updateComplete,this.visible&&(this.reset_properties(),await Promise.all([this._getFacets()]))}async _onAppStateUpdate(e){requestAnimationFrame(()=>this.doUpdate(e))}_onSearch(e){let t="/search";"RP-SEARCH"==e.target.nodeName&&(t="all"==e.target.searchObject.facet.id?"/search?s="+encodeURIComponent(e.target.inputValue):`/search/${e.target.searchObject.facet.id}?s=${encodeURIComponent(e.target.inputValue)}`),this.AppStateModel.setLocation(t)}_handleResize(){if(!this.visible)return;let e=window.innerWidth;this.setPeopleWidth(e)}setPeopleWidth(e){let t=250;e<576?t=e-30-72:e<768&&(t=.7*(e-30)-72-30),this.peopleWidth=Math.floor(t)}async _getPeople(){let e=await this.CollectionModel.overview("randomPeople",{limit:4,total:this.peopleTotal});this.peopleStatus=e.state,"loaded"==e.state&&(this.people=e.payload.results,console.log(this.people))}async _getFacets(){let e=await this.CollectionModel.overview("facets");if(this.facetsStatus=e.state,"loaded"==e.state){this.facets=e.payload.aggregations.facets["@type"];for(let e in this.facets){for(let t of this.CollectionModel.subFacets.works)if(e==t.es){this.academicWorks.push({text:t.text,count:this.facets[e],href:"/works/"+t.id});break}e==this.context+":publication"&&(this.academicWorksTotal=this.facets[e]),e==this.context+":person"&&(this.peopleTotal=this.facets[e])}this.academicWorks.sort((function(e,t){let i=e.text.toUpperCase(),r=t.text.toUpperCase();return i<r?-1:i>r?1:0}))}}}customElements.define("rp-page-home",h)},89:function(e,t,i){"use strict";var r=i(2),s=i(33);i(35);function o(){return r.b`
  ...
  `}class n extends r.a{static get properties(){return{themeColor:{type:String,attribute:"theme-color"}}}constructor(){super(),this.render=o.bind(this),this.themeColor="danger"}_constructClasses(){let e={};return e[this.themeColor]=!0,e}}customElements.define("rp-alert",n)},90:function(e,t,i){"use strict";var r=i(2),s=i(35);i(91);function o(){return r.b`
  <style>
    :host {
      display: block;
    }
  ...
  `}i(92);class n extends r.a{static get properties(){return{name:{type:String},href:{type:String},title:{type:String},badges:{type:Array},avatarSize:{type:String,attribute:"avatar-size"},avatarSrc:{type:String,attribute:"avatar-src"},textWidth:{type:String,attribute:"text-width"}}}constructor(){super(),this.render=o.bind(this),this.badges=[],this.textWidth=window.innerWidth.toString()-70+"px"}_renderBadge(e){if("string"==typeof e)return r.b`<rp-badge>${e}</rp-badge>`;if("object"==typeof e){let t=e.text;if(!t)return r.b``;let i=e.href;return i?r.b`<rp-badge href="${i}">${t}</rp-badge>`:r.b`<rp-badge>${t}</rp-badge>`}return r.b``}}customElements.define("rp-person-preview",n)},91:function(e,t,i){"use strict";var r=i(2),s=i(33),o=i(35);function n(){return r.b`
  <style>
    :host {
      display: inline-block;
    }
...
`}class n extends r.a{static get properties(){return{size:{type:String},href:{type:String},colorSequence:{type:Number,attribute:"color-sequence"}}}constructor(){super(),this.maxColor=6,this.render=o.bind(this)}constructClasses(){let e={};if(this.size&&(e["size-"+this.size]=!0),this.colorSequence){e["color-"+Math.floor(this.colorSequence).toString()]=!0}else{let t=[...this.parentNode.childNodes].filter(e=>e.tagName===this.tagName);if(t.length>0){e["color-"+(t.indexOf(this)%this.maxColor).toString()]=!0}else e["color-0"]=!0}return e}_renderBadge(){return this.href?r.b`<a href=${this.href}>${this._renderSpan()}</a>`:r.b`${this._renderSpan()}`}_renderSpan(){return r.b`<span class=${Object(s.a)(this.constructClasses())}>
      <slot></slot>
    </span>`}}customElements.define("rp-badge",n)},93:function(e,t,i){"use strict";var r=i(2),s=i(33);i(35);function o(){return r.b`
  <style>
    :host {
      display: block;
    }
  ...
  `}i(33),i(93);class o extends r.a{static get properties(){return{links:{type:Array},viewAllLink:{type:Object,attribute:"view-all-link"},header:{type:Object,attribute:"header"}}}constructor(){super(),this.render=s.bind(this),this.links=[],this._linkClick=new CustomEvent("link-click",{detail:{message:"A new link has been clicked."}})}_renderHeader(){return this.header&&this.header.text?r.b`<div class="row header">
