...
Code distributed by Google as part of the polymer project is also
subject to an additional IP rights grant found at http://polymer.github.io/PATENTS.txt
*/const P=Object(x.a)(h(Object(s.a)(HTMLElement)));customElements.define("dom-bind",class extends P{static get observedAttributes(){return["mutable-data"]}constructor(){if(super(),l.m)throw new Error("strictTemplatePolicy: dom-bind not allowed");this.root=null,this.$=null,this.__children=null}attributeChangedCallback(t,e,n,i){this.mutableData=!0}connectedCallback(){H()||(this.style.display="none"),this.render()}disconnectedCallback(){this.__removeChildren()}__insertChildren(){Object(c.a)(Object(c.a)(this).parentNode).insertBefore(this.root,this)}__removeChildren(){if(this.__children)for(let t=0;t<this.__children.length;t++)this.root.appendChild(this.__children[t])}render(){let t;if(!this.__children){if(t=t||this.querySelector("template"),!t){let e=new MutationObserver(()=>{if(t=this.querySelector("template"),!t)throw new Error("dom-bind requires a <template> child");e.disconnect(),this.render()});return void e.observe(this,{childList:!0})}this.root=this._stampTemplate(t),this.$=this.root.$,this.__children=[];for(let t=this.root.firstChild;t;t=t.nextSibling)this.__children[this.__children.length]=t;this._enableProperties()}this.__insertChildren(),this.dispatchEvent(new CustomEvent("dom-change",{bubbles:!0,composed:!0}))}});var L=n(27),E=n(19),V=n(24),A=n(3),T=n(13);
/**
@license
Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
This code may only be used under the BSD style license found at http://polymer.github.io/LICENSE.txt
...
Code distributed by Google as part of the polymer project is also
subject to an additional IP rights grant found at http://polymer.github.io/PATENTS.txt
*/let i,s,r=/(url\()([^)]*)(\))/g,o=/(^\/[^\/])|(^#)|(^[\w-\d]*:)/;function a(t,e){if(t&&o.test(t))return t;if("//"===t)return t;if(void 0===i){i=!1;try{const t=new URL("b","http://a");t.pathname="c%20d",i="http://a/c%20d"===t.href}catch(t){}}if(e||(e=document.baseURI||window.location.href),i)try{return new URL(t,e).href}catch(e){return t}return s||(s=document.implementation.createHTMLDocument("temp"),s.base=s.createElement("base"),s.head.appendChild(s.base),s.anchor=s.createElement("a"),s.body.appendChild(s.anchor)),s.base.href=e,s.anchor.href=t,s.anchor.href||t}function h(t,e){return t.replace(r,(function(t,n,i,s){return n+"'"+a(i.replace(/["']/g,""),e)+"'"+s}))}function l(t){return t.substring(0,t.lastIndexOf("/")+1)}},function(t,e,n){t.exports={BaseModel:n(59),BaseStore:n(61),BaseService:n(63),BaseMixin:n(65),Mixin:n(66),EventBus:n(35),EventInterface:n(67),LitCorkUtils:n(68),fetch:n(50),LightDom:n(69)}},function(t,e,n){"use strict";n.d(e,"a",(function(){return i})),n.d(e,"b",(function(){return r})),n.d(e,"c",(function(){return o}));n(5),n(6),n(13);
/**
@license
Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
This code may only be used under the BSD style license found at http://polymer.github.io/LICENSE.txt
...
Code distributed by Google as part of the polymer project is also
subject to an additional IP rights grant found at http://polymer.github.io/PATENTS.txt
*/const i={},s=/-[a-z]/g,r=/([A-Z])/g;function o(t){return i[t]||(i[t]=t.indexOf("-")<0?t:t.replace(s,t=>t[1].toUpperCase()))}function a(t){return i[t]||(i[t]=t.replace(r,"-$1").toLowerCase())}},function(t,e,n){"use strict";n.d(e,"b",(function(){return s})),n.d(e,"a",(function(){return r}));var i=n(7);
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * http://polymer.github.io/PATENTS.txt
 */
const i=new WeakMap,s=t=>(...e)=>{const n=t(...e);return i.set(n,!0),n},r=t=>"function"==typeof t&&i.has(t)},function(t,e,n){"use strict";n.d(e,"a",(function(){return r}));var i=n(21),s=n(9);n.d(e,"b",(function(){return s.a}));
/**
@license
Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
This code may only be used under the BSD style license found at http://polymer.github.io/LICENSE.txt
...
subject to an additional IP rights grant found at http://polymer.github.io/PATENTS.txt
*/
const r=Object(i.a)(HTMLElement)},function(t,e,n){"use strict";n.d(e,"c",(function(){return s})),n.d(e,"b",(function(){return r})),n.d(e,"a",(function(){return o}));var i=n(20);
/**
@license
Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
This code may only be used under the BSD style license found at http://polymer.github.io/LICENSE.txt
...
subject to an additional IP rights grant found at http://polymer.github.io/PATENTS.txt
*/
let a="string"==typeof document.head.style.touchAction,h="__polymerGesturesHandled",l="__polymerGesturesTouchAction",c=["mousedown","mousemove","mouseup","click"],d=[0,1,4,2],p=function(){try{return 1===new MouseEvent("test",{buttons:1}).buttons}catch(t){return!1}}();function u(t){return c.indexOf(t)>-1}let f=!1;function m(t){if(!u(t)&&"touchend"!==t)return a&&f&&r.i?{passive:!0}:void 0}!function(){try{let t=Object.defineProperty({},"passive",{get(){f=!0}});window.addEventListener("test",null,t),window.removeEventListener("test",null,t)}catch(t){}}();let v=navigator.userAgent.match(/iP(?:[oa]d|hone)|Android/);const g=[],_={button:!0,input:!0,keygen:!0,meter:!0,output:!0,textarea:!0,progress:!0,select:!0},y={button:!0,command:!0,fieldset:!0,input:!0,keygen:!0,optgroup:!0,option:!0,select:!0,textarea:!0};function b(t){let e=Array.prototype.slice.call(t.labels||[]);if(!e.length){e=[];let n=t.getRootNode();if(t.id){let i=n.querySelectorAll(`label[for = ${t.id}]`);for(let t=0;t<i.length;t++)e.push(i[t])}}return e}let z=function(t){let e=t.sourceCapabilities;var n;if((!e||e.firesTouchEvents)&&(t[h]={skip:!0},"click"===t.type)){let e=!1,i=O(t);for(let t=0;t<i.length;t++){if(i[t].nodeType===Node.ELEMENT_NODE)if("label"===i[t].localName)g.push(i[t]);else if(n=i[t],_[n.localName]){let n=b(i[t]);for(let t=0;t<n.length;t++)e=e||g.indexOf(n[t])>-1}if(i[t]===S.mouse.target)return}if(e)return;t.preventDefault(),t.stopPropagation()}};function w(t){let e=v?["click"]:c;for(let n,i=0;i<e.length;i++)n=e[i],t?(g.length=0,document.addEventListener(n,z,!0)):document.removeEventListener(n,z,!0)}function C(t){let e=t.type;if(!u(e))return!1;if("mousemove"===e){let e=void 0===t.buttons?1:t.buttons;return t instanceof window.MouseEvent&&!p&&(e=d[t.which]||0),Boolean(1&e)}return 0===(void 0===t.button?0:t.button)}let S={mouse:{target:null,mouseIgnoreJob:null},touch:{x:0,y:0,id:-1,scrollDecided:!1}};function M(t,e,n){t.movefn=e,t.upfn=n,document.addEventListener("mousemove",e),document.addEventListener("mouseup",n)}function x(t){document.removeEventListener("mousemove",t.movefn),document.removeEventListener("mouseup",t.upfn),t.movefn=null,t.upfn=null}r.b&&document.addEventListener("touchend",(function(t){if(!r.b)return;S.mouse.mouseIgnoreJob||w(!0),S.mouse.target=O(t)[0],S.mouse.mouseIgnoreJob=s.a.debounce(S.mouse.mouseIgnoreJob,i.b.after(2500),(function(){w(),S.mouse.target=null,S.mouse.mouseIgnoreJob=null}))}),!!f&&{passive:!0});const O=window.ShadyDOM&&window.ShadyDOM.noPatch?window.ShadyDOM.composedPath:t=>t.composedPath&&t.composedPath()||[],H={},P=[];function L(t){const e=O(t);return e.length>0?e[0]:t.target}function E(t){let e,n=t.type,i=t.currentTarget.__polymerGestures;if(!i)return;let s=i[n];if(s){if(!t[h]&&(t[h]={},"touch"===n.slice(0,5))){let e=(t=t).changedTouches[0];if("touchstart"===n&&1===t.touches.length&&(S.touch.id=e.identifier),S.touch.id!==e.identifier)return;a||"touchstart"!==n&&"touchmove"!==n||function(t){let e=t.changedTouches[0],n=t.type;if("touchstart"===n)S.touch.x=e.clientX,S.touch.y=e.clientY,S.touch.scrollDecided=!1;else if("touchmove"===n){if(S.touch.scrollDecided)return;S.touch.scrollDecided=!0;let n=function(t){let e="auto",n=O(t);for(let t,i=0;i<n.length;i++)if(t=n[i],t[l]){e=t[l];break}return e}(t),i=!1,s=Math.abs(S.touch.x-e.clientX),r=Math.abs(S.touch.y-e.clientY);t.cancelable&&("none"===n?i=!0:"pan-x"===n?i=r>s:"pan-y"===n&&(i=s>r)),i?t.preventDefault():I("track")}}(t)}if(e=t[h],!e.skip){for(let n,i=0;i<P.length;i++)n=P[i],s[n.name]&&!e[n.name]&&n.flow&&n.flow.start.indexOf(t.type)>-1&&n.reset&&n.reset();for(let i,r=0;r<P.length;r++)i=P[r],s[i.name]&&!e[i.name]&&(e[i.name]=!0,i[n](t))}}}function V(t,e,n){return!!H[e]&&(function(t,e,n){let i=H[e],s=i.deps,r=i.name,o=t.__polymerGestures;o||(t.__polymerGestures=o={});for(let e,n,i=0;i<s.length;i++)e=s[i],v&&u(e)&&"click"!==e||(n=o[e],n||(o[e]=n={_count:0}),0===n._count&&t.addEventListener(e,E,m(e)),n[r]=(n[r]||0)+1,n._count=(n._count||0)+1);t.addEventListener(e,n),i.touchAction&&k(t,i.touchAction)}(t,e,n),!0)}function A(t,e,n){return!!H[e]&&(function(t,e,n){let i=H[e],s=i.deps,r=i.name,o=t.__polymerGestures;if(o)for(let e,n,i=0;i<s.length;i++)e=s[i],n=o[e],n&&n[r]&&(n[r]=(n[r]||1)-1,n._count=(n._count||1)-1,0===n._count&&t.removeEventListener(e,E,m(e)));t.removeEventListener(e,n)}(t,e,n),!0)}function T(t){P.push(t);for(let e=0;e<t.emits.length;e++)H[t.emits[e]]=t}function k(t,e){a&&t instanceof HTMLElement&&i.a.run(()=>{t.style.touchAction=e}),t[l]=e}function N(t,e,n){let i=new Event(e,{bubbles:!0,cancelable:!0,composed:!0});if(i.detail=n,Object(o.a)(t).dispatchEvent(i),i.defaultPrevented){let t=n.preventer||n.sourceEvent;t&&t.preventDefault&&t.preventDefault()}}function I(t){let e=function(t){for(let e,n=0;n<P.length;n++){e=P[n];for(let n,i=0;i<e.emits.length;i++)if(n=e.emits[i],n===t)return e}return null}(t);e.info&&(e.info.prevent=!0)}function j(t,e,n,i){e&&N(e,t,{x:n.clientX,y:n.clientY,sourceEvent:n,preventer:i,prevent:function(t){return I(t)}})}function R(t,e,n){if(t.prevent)return!1;if(t.started)return!0;let i=Math.abs(t.x-e),s=Math.abs(t.y-n);return i>=5||s>=5}function D(t,e,n){if(!e)return;let i,s=t.moves[t.moves.length-2],r=t.moves[t.moves.length-1],o=r.x-t.x,a=r.y-t.y,h=0;s&&(i=r.x-s.x,h=r.y-s.y),N(e,"track",{state:t.state,x:n.clientX,y:n.clientY,dx:o,dy:a,ddx:i,ddy:h,sourceEvent:n,hover:function(){return function(t,e){let n=document.elementFromPoint(t,e),i=n;for(;i&&i.shadowRoot&&!window.ShadyDOM;){let s=i;if(i=i.shadowRoot.elementFromPoint(t,e),s===i)break;i&&(n=i)}return n}(n.clientX,n.clientY)}})}function F(t,e,n){let i=Math.abs(e.clientX-t.x),s=Math.abs(e.clientY-t.y),r=L(n||e);!r||y[r.localName]&&r.hasAttribute("disabled")||(isNaN(i)||isNaN(s)||i<=25&&s<=25||function(t){if("click"===t.type){if(0===t.detail)return!0;let e=L(t);if(!e.nodeType||e.nodeType!==Node.ELEMENT_NODE)return!0;let n=e.getBoundingClientRect(),i=t.pageX,s=t.pageY;return!(i>=n.left&&i<=n.right&&s>=n.top&&s<=n.bottom)}return!1}(e))&&(t.prevent||N(r,"tap",{x:e.clientX,y:e.clientY,sourceEvent:e,preventer:n}))}T({name:"downup",deps:["mousedown","touchstart","touchend"],flow:{start:["mousedown","touchstart"],end:["mouseup","touchend"]},emits:["down","up"],info:{movefn:null,upfn:null},reset:function(){x(this.info)},mousedown:function(t){if(!C(t))return;let e=L(t),n=this;M(this.info,(function(t){C(t)||(j("up",e,t),x(n.info))}),(function(t){C(t)&&j("up",e,t),x(n.info)})),j("down",e,t)},touchstart:function(t){j("down",L(t),t.changedTouches[0],t)},touchend:function(t){j("up",L(t),t.changedTouches[0],t)}}),T({name:"track",touchAction:"none",deps:["mousedown","touchstart","touchmove","touchend"],flow:{start:["mousedown","touchstart"],end:["mouseup","touchend"]},emits:["track"],info:{x:0,y:0,state:"start",started:!1,moves:[],addMove:function(t){this.moves.length>2&&this.moves.shift(),this.moves.push(t)},movefn:null,upfn:null,prevent:!1},reset:function(){this.info.state="start",this.info.started=!1,this.info.moves=[],this.info.x=0,this.info.y=0,this.info.prevent=!1,x(this.info)},mousedown:function(t){if(!C(t))return;let e=L(t),n=this,i=function(t){let i=t.clientX,s=t.clientY;R(n.info,i,s)&&(n.info.state=n.info.started?"mouseup"===t.type?"end":"track":"start","start"===n.info.state&&I("tap"),n.info.addMove({x:i,y:s}),C(t)||(n.info.state="end",x(n.info)),e&&D(n.info,e,t),n.info.started=!0)};M(this.info,i,(function(t){n.info.started&&i(t),x(n.info)})),this.info.x=t.clientX,this.info.y=t.clientY},touchstart:function(t){let e=t.changedTouches[0];this.info.x=e.clientX,this.info.y=e.clientY},touchmove:function(t){let e=L(t),n=t.changedTouches[0],i=n.clientX,s=n.clientY;R(this.info,i,s)&&("start"===this.info.state&&I("tap"),this.info.addMove({x:i,y:s}),D(this.info,e,n),this.info.state="track",this.info.started=!0)},touchend:function(t){let e=L(t),n=t.changedTouches[0];this.info.started&&(this.info.state="end",this.info.addMove({x:n.clientX,y:n.clientY}),D(this.info,e,n))}}),T({name:"tap",deps:["mousedown","click","touchstart","touchend"],flow:{start:["mousedown","touchstart"],end:["click","touchend"]},emits:["tap"],info:{x:NaN,y:NaN,prevent:!1},reset:function(){this.info.x=NaN,this.info.y=NaN,this.info.prevent=!1},mousedown:function(t){C(t)&&(this.info.x=t.clientX,this.info.y=t.clientY)},click:function(t){C(t)&&F(this.info,t)},touchstart:function(t){const e=t.changedTouches[0];this.info.x=e.clientX,this.info.y=e.clientY},touchend:function(t){F(this.info,t.changedTouches[0],t)}})},function(t,e,n){"use strict";n.d(e,"a",(function(){return X}));n(5);var i=n(0),s=n(6),r=n(3),o=n(22),a=n(42);
/**
@license
Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
This code may only be used under the BSD style license found at http://polymer.github.io/LICENSE.txt
 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */const s=new WeakMap,r=Object(i.d)(t=>e=>{if(!(e instanceof i.a)||e instanceof i.c||"style"!==e.committer.name||e.committer.parts.length>1)throw new Error("The `styleMap` directive must be used in the style attribute and must be the only part in the attribute.");const{committer:n}=e,{style:r}=n.element;let o=s.get(e);void 0===o&&(r.cssText=n.strings.join(" "),s.set(e,o=new Set)),o.forEach(e=>{e in t||(o.delete(e),-1===e.indexOf("-")?r[e]=null:r.removeProperty(e))});for(const e in t)o.add(e),-1===e.indexOf("-")?r[e]=t[e]:r.setProperty(e,t[e])})},function(t,e,n){const i=n(60).EventEmitter;t.exports=new class extends i{constructor(){super(),this.setMaxListeners(1e4)}}},function(t,e,n){"use strict";n.d(e,"a",(function(){return o}));var i=n(10),s=n(11);
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
...
subject to an additional IP rights grant found at http://polymer.github.io/PATENTS.txt
*/
function it(){document.body.removeAttribute("unresolved")}"interactive"===document.readyState||"complete"===document.readyState?it():window.addEventListener("DOMContentLoaded",it);var st=n(4),rt=n(31),ot=n(19),at=n(13),ht=n(3),lt=n(0);
/**
@license
Copyright (c) 2019 The Polymer Project Authors. All rights reserved.
This code may only be used under the BSD style license found at http://polymer.github.io/LICENSE.txt
...
part of the polymer project is also subject to an additional IP rights grant
found at http://polymer.github.io/PATENTS.txt
*/var P,L,E={pageX:0,pageY:0},V=null,A=[],T=["wheel","mousewheel","DOMMouseScroll","touchstart","touchmove"];function k(t){I.indexOf(t)>=0||(0===I.length&&function(){P=P||D.bind(void 0);for(var t=0,e=T.length;t<e;t++)document.addEventListener(T[t],P,{capture:!0,passive:!1})}(),I.push(t),L=I[I.length-1],j=[],R=[])}function N(t){var e=I.indexOf(t);-1!==e&&(I.splice(e,1),L=I[I.length-1],j=[],R=[],0===I.length&&function(){for(var t=0,e=T.length;t<e;t++)document.removeEventListener(T[t],P,{capture:!0,passive:!1})}())}const I=[];let j=null,R=null;function D(t){if(t.cancelable&&function(t){var e=Object(g.a)(t).rootTarget;"touchmove"!==t.type&&V!==e&&(V=e,A=function(t){for(var e=[],n=t.indexOf(L),i=0;i<=n;i++)if(t[i].nodeType===Node.ELEMENT_NODE){var s=t[i],r=s.style;"scroll"!==r.overflow&&"auto"!==r.overflow&&(r=window.getComputedStyle(s)),"scroll"!==r.overflow&&"auto"!==r.overflow||e.push(s)}return e}(Object(g.a)(t).path));if(!A.length)return!0;if("touchstart"===t.type)return!1;var n=function(t){var e={deltaX:t.deltaX,deltaY:t.deltaY};if("deltaX"in t);else if("wheelDeltaX"in t&&"wheelDeltaY"in t)e.deltaX=-t.wheelDeltaX,e.deltaY=-t.wheelDeltaY;else if("wheelDelta"in t)e.deltaX=0,e.deltaY=-t.wheelDelta;else if("axis"in t)e.deltaX=1===t.axis?t.detail:0,e.deltaY=2===t.axis?t.detail:0;else if(t.targetTouches){var n=t.targetTouches[0];e.deltaX=E.pageX-n.pageX,e.deltaY=E.pageY-n.pageY}return e}
/**
@license
Copyright (c) 2015 The Polymer Project Authors. All rights reserved.
This code may only be used under the BSD style license found at
...
</iron-iconset-svg>`;document.head.appendChild(y.content);var b=n(54),z=n.n(b);let w=document.createElement("div");w.style.display="none",w.innerHTML=z.a,document.head.appendChild(w);const C=document.createElement("template");C.innerHTML=o.a,document.head.appendChild(C.content);n(70),n(77),n(79),n(58),n(57);var S=n(46),M=n(22);
/**
@license
Copyright (c) 2015 The Polymer Project Authors. All rights reserved.
This code may only be used under the BSD style license found at
...
*/Object(u.a)({_template:c.a`
    ...
    <slot></slot>
`,is:"iron-pages",behaviors:[S.a,O],properties:{activateEvent:{type:String,value:null}},observers:["_selectedPageChanged(selected)"],_selectedPageChanged:function(t,e){this.async(this.notifyResize)}});class H extends(Mixin(i.a).with(LitCorkUtils)){static get properties(){return{appRoutes:{type:Array},page:{type:String},theme:{type:Object},navLinks:{type:Array},user:{type:Object},textQuery:{type:String}}}constructor(){super(),this.render=a.bind(this),this.appRoutes=APP_CONFIG.appRoutes,this.theme=APP_CONFIG.theme,this.page="loading",this.loadedPages={},this.user=APP_CONFIG.user,this.textQuery="",this.navLinks=[{text:"People",page:"people",href:"/people"},{text:"Organizations",page:"organizations",href:"#"},{text:"Works",page:"works",href:"#"},{text:"Help",page:"help",href:"#"}],this._injectModel("AppStateModel")}async _onAppStateUpdate(t){console.log("Current app state:",t),t.location.query.s?this.textQuery=t.location.query.s:this.textQuery="";let e=t.page;this.loadedPages[e]||(this.page="loading",this.loadedPages[e]=this.loadPage(e)),await this.loadedPages[e],this.page=e}loadPage(t){return"home"===t?n.e(2).then(n.bind(null,97)):"components"===t?n.e(1).then(n.bind(null,96)):"people"===t?n.e(4).then(n.bind(null,98)):"individual"===t?n.e(3).then(n.bind(null,99)):"search"===t?n.e(5).then(n.bind(null,100)):void 0}_renderMasthead(){if(!this.theme.masthead)return i.b``;let t={};return t["background-image"]=`url(${this.theme.masthead})`,i.b`<div id="masthead" class="text-light flex align-items-center" style="${Object(h.a)(t)}">
          ...
          </div>`)}return t.length>0?i.b`${t}`:i.b``}}customElements.define("researcher-profiles",H)},function(t,e,n){"use strict";n.r(e);var i=n(27),s=(n(8),n(12)),r=n(4);
/**
@license
Copyright (c) 2015 The Polymer Project Authors. All rights reserved.
This code may only be used under the BSD style license found at
