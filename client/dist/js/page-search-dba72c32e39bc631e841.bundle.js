(window.webpackJsonp=window.webpackJsonp||[]).push([[6],{106:function(t,e,a){"use strict";a.r(e);var s=a(2),i=a(34),d=a.n(i);function n(){return s.b`
...
`}class c extends r.a{static get properties(){return{}}constructor(){super(),this.render=o.bind(this),this.AppStateModel.get().then(t=>this._onAppStateUpdate(t))}async _onAppStateUpdate(t){requestAnimationFrame(()=>this.doUpdate(t))}async doUpdate(t){await this.updateComplete,this.visible&&(this._parseUrlQuery(t),await Promise.all([this._doMainQuery(),this._getFacets(),this._getAzAgg()]))}async _getFacets(){let t=await this.CollectionModel.overview("organizationsAggs");this.subFacetStatus=t.state,"loaded"==t.state&&(this.subFacets=this.CollectionModel._getSubFacets("organizations",t.payload,this.currentQuery))}}function h(){return s.b`
...
`}customElements.define("rp-page-organizations",c);a(94),a(96);class p extends r.a{static get properties(){return{}}constructor(){super(),this.render=h.bind(this),this.AppStateModel.get().then(t=>this._onAppStateUpdate(t))}updated(t){if(this.doUpdated(t),t.has("mainFacet")&&"none"!=this.mainFacet){let t=!1,e=0;for(let a of this.CollectionModel.mainFacets)if(e++,a.id.toLowerCase()==this.mainFacet.toLowerCase()){t=!0,this.mainFacetIndex=e;break}t||(this.mainFacet="none",this.mainFacetIndex=0)}}async _onAppStateUpdate(t){requestAnimationFrame(()=>this.doUpdate(t))}async doUpdate(t){await this.updateComplete,this.visible&&(this._parseUrlQuery(t),await Promise.all([this._doMainQuery(),this._getSearchAggs()]))}}customElements.define("rp-page-search",p)}}]);