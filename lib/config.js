...
let serverConfig = Object.assign(config, {
  ...
  client : {
    ...
    theme : {
      ...
      homeHeroTitle : "At UC Davis, Some Pithy Headline About Research Belongs Here",
      homeHeroContentTop : `<div>The registry is a research-focused discovery tool that enables
                        collaboration among scholars of all disciplines.</div>`,
